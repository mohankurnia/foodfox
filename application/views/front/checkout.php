    ...
    <div class="row">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4"></td>
                            <?php  if($this->cart->total_items() > 0) { ?>
                            <td class="text-left">Total: <b><?php echo 'Rp. '.$this->cart->total().'K';?></b></td>
                            <?php } ?>
                        </tr>
                    </tfoot>
                </table>
        ...
        <div class="col-md-4">
            <form action="<?php echo base_url().'checkout/index';?>" method="POST"
                ...
                <h3 class="mt-3">Detail Pengiriman</h3><hr>
                ...
                <div class="container p-2 mb-3" style="background: #e5e5e5;">
                    Bayar dengan Cash on Delivery
                </div>
                <div>
                    <a href="<?php echo base_url().'cart'; ?>" class="btn btn-warning"><i class="fas fa-angle-left"></i>
                        Kembali</a>
                    <button type="submit" name="placeOrder" class="btn btn-success float-right">Pesan <i
