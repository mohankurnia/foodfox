    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption text-left">
                ...
                <h3>Baik, kami di sini untuk melayani Anda</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg mr-5">Order Sekarang</a>
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption text-right">
                <h1 class="display-2">Ingin Makanan Enak?!</h1>
                <h3>Kami akan siapkan segera</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg mr-5">Order Sekarang</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">Lihat Menu</a>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="carousel-caption text-right">
                <h1 class="display-2">Mau Makanan Sehat?!</h1>
                <h3>Tenang kami akan menyajikan makanan yang sehat dan higienis</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg mr-5">Order Sekarang</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">Lihat Menu</a>
            </div>
        </div>
...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        ...
        <div class="col-12">
            <p class="lead">
                Cara termudah untuk memesan makanan Anda. FoodFox menyediakan pengiriman cepat 
                dengan dalam 30 menit dan berikan makanan gratis jika pesanan tidak tepat waktu. Jadi tunggu apalagi, pesan sekarang juga!
            </p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <p>Hal pertama yang dapat Anda lakukan adalah memilih dari mitra restaurant kami dengan mudah!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <i class="fas fa-bullseye"></i>
            <h3>Pilih Hidangan yang Lezat</h3>
            <p>Kami menyediakan Anda dengan menu dari berbagai restaurant pengiriman online!</p>
        </div>
        <div class="col-sm-12 col-md-4">
        <i class="fas fa-clipboard-check"></i>
            <h3>Pengambilan atau Pengiriman</h3>
            <p>Lagi pula, makanan akan dikirim atau Anda dapat mengambilnya sesuai pilihan Anda!</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Makanan Terpopuler</h1>
        </div>
        <hr>
    </div>
</div>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <h4 class="text-muted"><b>Rp. <?php echo $dish['price']; ?>K</b></h4>
                    </div>
...
<section id="contact-us" class="container shadow my-4 p-4">
    ...
    <p class="text-center">Selalu disini untuk mu</p>
    <!--Section description-->
    ...
    <form name="contact-form" action="<?php echo base_url().'home/sendMail'; ?>" id="myForm" method="POST">
        <div class="row">
            ...
            <div class="col-md-6">
                <div>
                    <label class="mb-0" for="email" class="">E-mail*</label>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-2">
                    <label class="mb-0" for="message">Pesanmu*</label>
...
const validate = () => {
    ...
    if (emailVal === "") {
        ...
        setErrorMsg(email, 'masukkan e-mail yang valid');
    } else {
        setSuccessMsg(email);
    }
    ...
    //subject can not
    if (subjectVal === "") {
        setErrorMsg(subject, 'subject tidak boleh kosong');
    } else {
