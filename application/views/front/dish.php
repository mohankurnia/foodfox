<div class="container p-4">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Menu di <?php echo $res['name']; ?></h1>
        </div>
    </div>
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    Pesta keindahan menanti Anda dengan hidangan super musiman yang dibuat dengan cinta oleh koki kami yang luar biasa.
                </p>
            </div>
        </div>
    </div>
