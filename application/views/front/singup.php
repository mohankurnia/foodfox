...
<head>
    ...
    <title><title>FoodFox | <?= isset($title) ? $title : 'Default Title' ; ?></title></title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="wrapper container">
        ...
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName"
                            placeholder="Nama Belakang" value="<?php echo set_value('lastname')?>">
                ...
                <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                            placeholder="Nama Depan" value="<?php echo set_value('firstname')?>">
                ...
                <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" name="phone" placeholder="Kontak"
        ...
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
            ...
            <button type="submit" class="btn btn-primary btn-block mb-4">Buat Akun</button>
    ...
    const validate = () => {
        ...
        if (emailVal === "") {
            ...
            setErrorMsg(email, 'email tidak valid');
        } else {
            setSuccessMsg(email);
        }
        ...
        if (passVal === "") {
            ...
            setErrorMsg(pass, 'panjang password harus antara 8 dan 15 karakter');
        } else {
            setSuccessMsg(pass);
        }
        ...
        if (phoneVal === "") {
            ...
            setErrorMsg(phone, 'kontak tidak valid');
        } else {
            setSuccessMsg(phone);
        }
        ...
        if (addressVal === "") {
            ...
            setErrorMsg(address, "alamat tidak valid");
        } else {
