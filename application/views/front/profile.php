                ...
                <div class="py-2">
                    <div>
                        <input type="password"
                            ...
                            name="cPassword" placeholder="Password Terkini" value="<?php echo set_value('cPassword')?>">
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        <button type="submit" class="btn btn-primary mr-3 mb-2">Simpan</button>
                        <a href="<?php echo base_url().'home' ?>" class="btn border button mb-2">Batal</a>
                    </div>
                </div>
            </form>
        </div>
