<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/create_restaurant';?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center mb-3">Tambah Restaurant</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Nama Restaurant</label>
                    <input type="text" name="res_name" id="rname" class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : '';?>" placeholder="Masukkan Nama Restaurant"
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="o_days" id="o_days" class="form-control <?php echo (form_error('o_days') != "") ? 'is-invalid' : '';?>">
                        ...
                        <option value="24 Jam - Setiap hari">24 Jam - Setiap hari</option>
                    </select>
