<div>
    <form action="<?php echo base_url().'admin/store/edit/'.$store['r_id'];?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center mb-3">Edit Detail "<?php echo $store['name'] ?>"</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Nama Restaurant</label>
                    <input type="text" name="res_name"  class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : '';?>" placeholder="Tambah Nama Restaurant"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('o_hr') != "") ? 'is-invalid' : '';?>" data-placeholder="Pilih Category">
                ...
                <div class="form-group">
                    <label class="control-label">Waktu Tutup</label>
                    <select name="c_hr" id="c_hr" class="form-control
                    <?php echo (form_error('c_hr') != "") ? 'is-invalid' : '';?>" data-placeholder="Pilih Category">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('o_days') != "") ? 'is-invalid' : '';?>" data-placeholder="Pilih Category"
                        tabindex="1">
                        <option value="">-- Pilih Hari Buka --</option>
                        <option value="Senin - Selasa <?php echo $store['o_days'] == "Senin - Selasa" ? "selected" : "";?>">Senin - Selasa</option>
                        <option value="Senin - Rabu <?php echo $store['o_days'] == "Senin - Rabu" ? "selected" : "";?>">Senin - Rabu</option>
                        <option value="Senin - Kamis <?php echo $store['o_days'] == "Senin - Kamis" ? "selected" : "";?>">Senin - Kamis</option>
                        <option value="Senin - Jum'at <?php echo $store['o_days'] == "Senin - Jum'at" ? "selected" : "";?>">Senin - Jum'at</option>
                        <option value="Senin - Sabtu <?php echo $store['o_days'] == "Senin - Sabtu" ? "selected" : "";?>">Senin - Sabtu</option>
                        <option value="24 Jam - Setiap hari" <?php echo $store['o_days'] == "24 Jam - Setiap hari" ? "selected" : "";?>>24 Jam - Setiap hari</option>
                    </select>
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="control-label">Pilih Category</label>
