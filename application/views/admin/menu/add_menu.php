            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Masukkan Harga Rp. K" value="<?php echo set_value('price'); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Deskripsi Makanan" value="<?php echo set_value('about'); ?>">
...
<script>
    ...
    const validate = () => {
        ...
        if (resnameVal === "-- Pilih Restaurant --") {
            setErrorMsg(resname, 'pilih nama restaurant');
        } else {
        ...
        if (imageVal == "") {
            ...
            setErrorMsg(image, 'format gambar tidak mendukung');
        } else {
            setSuccessMsg(image);
        }
