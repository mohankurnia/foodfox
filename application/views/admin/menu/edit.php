<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit/'.$dish['d_id'];?>" method="POST"
        ...
        <h3 class="mb-3 text-center">Edit Makanan - <?php echo $dish['name']; ?></h3>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Masukkan Nama Makanan" value="<?php echo set_value('name', $dish['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Masukkan Harga Rp. K" value="<?php echo set_value('price', $dish['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Masukkan Deskripsi" value="<?php echo set_value('about', $dish['about']); ?>">
                    <span></span>
...
const validate = () => {
    ...
    if (resnameVal === "-- Pilih Restaurant --") {
        setErrorMsg(resname, 'pilih restaurant name');
    } else {
    ...
    if (aboutVal === "") {
        setErrorMsg(about, 'deskripsi tidak boleh kosong');
    } else {
        setSuccessMsg(about);
    }
