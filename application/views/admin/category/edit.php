<div class="container shadow-container">
    <h2 class="p-2 text-center">Edit Category Restaurant - <?php echo $cat['c_name'];?></h2>
...
<script>
    ...
    const validate = () => {
        ...
        if (categoryVal === "") {
            setErrorMsg(category, 'category tidak boleh kosong');
        } else if (categoryVal.length <= 4 || categoryVal.length >= 16) {
            setErrorMsg(category, 'panjang category harus antara 5 dan 15 karakter"');
        } else {
